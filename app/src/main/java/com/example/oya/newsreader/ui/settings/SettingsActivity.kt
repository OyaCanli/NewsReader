package com.example.oya.newsreader.ui.settings
...
import com.example.oya.newsreader.databinding.ActivitySettingsBinding
import dagger.hilt.android.AndroidEntryPoint
import android.content.Intent
import android.view.MenuItem
import com.example.oya.newsreader.common.Constants
import com.example.oya.newsreader.ui.main.MainActivity
...
class SettingsActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intentComingFrom = bundle?.getString(Constants.USER_CLICKED_SETTINGS_FROM) ?: MainActivity::class.java.simpleName
